 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://module10.mentoring.epam.com/", wsdlLocation = "http://localhost:1212/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://module10.mentoring.epam.com/", "HelloService");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://module10.mentoring.epam.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://module10.mentoring.epam.com/", "HelloPort"), Hello.class, features);
    }
